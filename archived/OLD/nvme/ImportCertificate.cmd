echo off &TITLE nvme driver, from femboyos, adopted by vzyssxs and ssos
:WELCOME
cls
echo.
echo READ BEFORE CONTINUING 
echo This is an experimental driver, if you don't want to take risks to the point of installing Windows again, don't install
...
echo. &echo.
powershell -Command "pnputil /add-driver "C:\bin\2\nvme\secnvme.inf" /install" >NUL 2>&1
@pause
